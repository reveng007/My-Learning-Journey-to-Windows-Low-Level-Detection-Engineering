# My-Learning-Journey-to-Windows-Low-Level-Detection-Engineering
...
5. [Windows Internals: Day 2]()
6. [Windows Internals: Day 3]() - From [Windows Internals Master](https://trainsec.net/windows-internals-master/) Path 
7. [Windows Internals: Day 4]() - From [Windows Internals Master](https://trainsec.net/windows-internals-master/) Path
8. [Windows Internals: Day 5]()
9. [x64 Architecture and Programming (Part 1)]()
10. [x64 Architecture and Programming (Part 2)]() - From [Windows Internals Master](https://trainsec.net/windows-internals-master/) Path
11. [Sysinternals Tools Deep Dive (Part 1)]() - From [Windows Internals Master](https://trainsec.net/windows-internals-master/) Path
12. [Windows System Programming 1]() - From [Windows Master Developer](https://trainsec.net/windows-master-developer/) Path
13. [Windows System Programming 2]() - From [Windows Master Developer](https://trainsec.net/windows-master-developer/) Path
14. [Windows System Programming 3]() - From [Windows Master Developer](https://trainsec.net/windows-master-developer/) Path
15. [COM Programming 1]() - From [Windows Master Developer](https://trainsec.net/windows-master-developer/) Path
16. [COM Programming 2]() - From [Windows Master Developer](https://trainsec.net/windows-master-developer/) Path
17. [Windows Kernel Programming 1]() - From [Windows Master Developer](https://trainsec.net/windows-master-developer/) Path
18. [Windows Kernel Programming 2]() - From [Windows Master Developer](https://trainsec.net/windows-master-developer/) Path
19. [Advanced Windows Kernel Programming]() - From [Advanced Windows Kernel Programming](https://trainsec.net/courses/advanced-windows-kernel-programming/)
...
21. [HTB: Windows Kernel Telemetry & Detection Techniques]() From [Windows Kernel Telemetry & Detection Techniques](https://academy.hackthebox.com/module/details/303) - Will Soon Share my Notes...
22. [HTB: Windows Low Level Detectability]() From [Windows Low Level Detectability](https://academy.hackthebox.com/module/details/311)
